...
# GROQ_API_KEY = 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

TIPOS_ARQUIVOS_VALIDOS = [
    'Site', 'Youtube', 'Pdf', 'Csv', 'Txt', 'docx', 'doc', 'pptx', 'ppt', 'xlsx', 'xls'
]
...
def carrega_arquivos(tipo_arquivo, arquivo):
    ...
    if tipo_arquivo == 'docx':
        with tempfile.NamedTemporaryFile(suffix='.docx', delete=False) as temp:
            temp.write(arquivo.read())
            nome_temp = temp.name
        documento = carrega_docx(nome_temp)
    return documento
